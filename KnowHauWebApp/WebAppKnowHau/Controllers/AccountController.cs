...
namespace WebAppKnowHau.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        /* public ActionResult Index()
         ...
         {
             var res =  dataService.GetLogin(Email, Senha);
             ...
             ModelState.AddModelError("", "Problemas no utilizador ou senha. Favor tentar novamente");
             return View();
         }*/
        ////////////////////////////////////////////////////////////////////////////////////////
        ...
        // POST: /Account/Login
        [HttpPost]
        [AllowAnonymous] //retirar isto provavelmente
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var res = await dataService.GetLogin(model.Email, pass);

            if (Convert.ToBoolean(res) == true)
            {
                Admin admin = new Admin();
                admin =  dataService.GetAdminEmailByIdAsync(model.Email);
                SuperAdmin superadmin = new SuperAdmin();
                superadmin = await dataService.GetSuperAdminEmailByIdAsync(model.Email);
                if (admin==null)
                {
                    if (superadmin == null)
                    {
                    ...
                    {
                        FormsAuthentication.SetAuthCookie(superadmin.username, false);
                        return RedirectToLocal(returnUrl);
                    }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //await this.UserManager.AddToRoleAsync(Use)
                ...
                ModelState.AddModelError("", "Admin já registado");
            }
